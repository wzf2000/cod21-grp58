...
parameter BASE_RAM_INIT_FILE = "D:\\rv\\cod21-grp58\\sim_tmp\\ucore.img"; //BaseRAM初始化文件，请修改为实际的绝对路�?
parameter EXT_RAM_INIT_FILE = "D:\\rv\\cod21-grp58\\sim_tmp\\rbl.img";    //ExtRAM初始化文件，请修改为实际的绝对路�?
// parameter EXT_RAM_INIT_FILE = "D:\\rv\\supervisor-rv-master\\kernel\\kernel.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�?
